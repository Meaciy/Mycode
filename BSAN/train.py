    ...
    def _train(self, criterion, optimizer, max_test_acc_overall=0):
        ...
        for epoch in range(self.opt.num_epoch):
            ...
            for i_batch, sample_batched in enumerate(self.train_dataloader):
                ...
                #text_bert_indices, attention_mask = word_level_replacement(text_bert_indices, attention_mask)
                #inputs=text_bert_indices, bert_segments_ids, attention_mask, asp_start, asp_end, adj_dep, edge_adj, src_mask, aspect_mask
...
def main():
    ...
    parser.add_argument('--attention_heads', default=4, type=int, help='number of multi-attention heads')
    ...
    parser.add_argument('--deprel_dim', type=int, default=2, help='Dependent relation embedding dimension.')
